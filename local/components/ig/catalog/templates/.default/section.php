    ...
    <div class="container">
        <div class="cat__head">
            <h1 class="cat__title">
                ...
                <span><? $APPLICATION->ShowViewContent('SECTION_COUNT'); ?> шт.</span>
            </h1>

            <p class="cat__descr">
                <? $APPLICATION->ShowViewContent('SECTION_TOP_SEO_TEXT'); ?>
            </p>
        ...
        <div class="cat__body">
            <div class="cat__block">
                ...
                <div class="cat__add">
                    <? $APPLICATION->ShowViewContent('SECTION_ADD'); ?>
                </div>

                <div class="cat__seo">
                    <? $APPLICATION->ShowViewContent('SECTION_BOTTOM_SEO_TEXT'); ?>
                </div>
